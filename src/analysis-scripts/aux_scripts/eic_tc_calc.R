...
df_ind_exams <- data.frame(ind = c('vacuna_gripe','ecocardio','fevi'),
                           descr = c('Vacunación antigripal','Ecocardiograma','Determinación fracción eyección ventrículo izq.'),
                           cod = c('eic_gripe','eic_eco','eic_fe'))
...
df_eic_exams_all <- rbind(df_eic_exams_all[[1]],df_eic_exams_all[[2]],df_eic_exams_all[[3]])
...
df_atc_tratamiento <- data.frame(ind = c('C03DA','C07','B01AC','C01EB18','C01EB15','C01DA','C08','C09','C10',
                                         'A10B','A10BJ'),
                                 filter = c('C03DA','C07','B01AC','C01EB18','C01EB15','C01DA','C08','C09','C10',
                                 ...
                                 cod = c('eic_antag_aldo','eic_bbloc','eic_antiagreg','eic_ranol','eic_trimet',
                                         'eic_nitra','eic_bloc_ca','eic_sra','eic_hipolip','eic_isglt2','eic_glp1'))
...
df_eic_atc_all <- rbind(df_eic_atc_all[[1]],df_eic_atc_all[[2]],df_eic_atc_all[[3]],
                        ...
                        df_eic_atc_all[[7]],df_eic_atc_all[[8]],df_eic_atc_all[[9]],
                        df_eic_atc_all[[10]],df_eic_atc_all[[11]])
...
df_all <- rbind(df_eic_global,df_eic_exams_all,df_eic_iam_all,df_eic_test_all,df_eic_test_all_nm,df_eic_atc_all,df_eic_dm2_all,df_eic_atc_dm_all)

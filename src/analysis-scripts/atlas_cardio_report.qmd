...
dbExecute(con, "CREATE OR REPLACE table main.poblacion_view as (
select año_cd,ccaa_cd,zbs_residencia_cd,sexo_cd, grupo_edad_cd_ as grupo_edad_cd, nivel_copago_cd,poblacion_nm from (
select año_cd,ccaa_cd,zbs_residencia_cd,sexo_cd,grupo_edad_cd, grupo_edad_cd + 1 as grupo_edad_cd_, nivel_copago_cd,poblacion_nm from main.poblacion))")
...
df_ind <- data.frame(ind = c('eic','eic_gripe','eic_eco','eic_iam','eic_ta','eic_ta_ctrl','eic_ldl',
                     ...
                     desc = c('Enfermedad isquémica cardiaca \n (EIC) en la población mayor de 18 años',
                              ...
                              'Colesterol LDL menor de 70 mg/dl (en la última determinación)', 
                              'Colesterol LDL menor de 55 mg/dl (en la última determinación)',
